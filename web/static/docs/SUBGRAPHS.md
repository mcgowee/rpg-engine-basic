...
For node-by-node behavior and diagrams, see **[GRAPHS.md](https://github.com/mcgowee/rpg-engine-basic/blob/main/docs/GRAPHS.md)** in the repository.
...
- **Cast with mood axes, portrait variants, gallery, long campaigns:** `narrator_chat`
