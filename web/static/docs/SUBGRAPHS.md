...
- In-app guides on your site: `/docs/stories`, `/docs/engine`, `/docs/playing`, `/docs/subgraphs`.
- Repository (markdown): [docs/ARCHITECTURE.md](https://github.com/mcgowee/rpg-engine-basic/blob/main/docs/ARCHITECTURE.md), [NODE_STATUS.md](https://github.com/mcgowee/rpg-engine-basic/blob/main/NODE_STATUS.md), [docs/INDEX.md](https://github.com/mcgowee/rpg-engine-basic/blob/main/docs/INDEX.md).
